...
/**
 * GR says that given two partitions of an integer (p and q) there exists a (0, 1) matrix A iff p* dominates q
 * such that the row sum vector r(A) = p and the column sum vector c(A) = q..
 */
public class GaleReiser {
    ...
    public GaleReiser(InputStreamReader is) {
